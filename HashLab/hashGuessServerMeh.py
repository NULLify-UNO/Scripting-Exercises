...
class Echo(protocol.Protocol):
	...
	def __init__(self, data):
		...
		ins.close()
		self.num1=random.randint(0,300)
		self.num2=random.randint(0,300)
	...
	def dataReceived(self, data):
		...
		if self.start >= 255:
			print "Someone got the Meh one!!!"
			self.transport.write("Great Job !! Are you ready to start threading Also, do you know you know your data structs?")
...
reactor.listenTCP(8672, EchoFactory())
reactor.run()
