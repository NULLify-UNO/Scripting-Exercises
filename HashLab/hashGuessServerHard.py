...
class Echo(protocol.Protocol):
	...
	def __init__(self, data):
		...
		ins.close()
		self.num1=random.randint(0,800)
		self.num2=random.randint(0,800)
	...
	def dataReceived(self, data):
		...
		if self.start >= 450:
			print "a winner is now"
			self.transport.write("congrats on being a super badass mofo!!!! \n tell mike george about how awesome you are!!! \n also tell spencer how much better you are then he is at this!!!")
...
reactor.listenTCP(8673, EchoFactory())
reactor.run()
